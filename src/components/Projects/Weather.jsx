...
import Image from "../../assets/Screenshot 2024-08-15 182059.png";
    ...
    <Container>
      <Wrapper>
        ...
        <TextHold>
          ...
          <TextThree>
            <Logo>
              <Link to={"https://weather-app-wmpm.vercel.app/"} style={{
                textDecoration: "none"
              }}>
                <nav>
            ...
            <LogoTwo>
              <Link to={"https://github.com/JbMichael890/Weather-App"} style={{
                textDecoration: "none"
              }}>
                <nav>
