...
import Image from "../../assets/Screenshot 2024-08-15 190254.png";
    ...
    <Container>
      <Wrapper>
        ...
        <TextHold>
          ...
          <TextThree>
            <Logo>
              <Link to={"https://user-data-omega.vercel.app/"} style={{
                textDecoration: "none"
              }}>
                <nav>
            ...
            <LogoTwo>
              <Link to={"https://github.com/JbMichael890/User-Data"} style={{
                textDecoration: "none"
              }}>
                <nav>
