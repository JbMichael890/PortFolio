      ...
      <Wrapper>
        ...
        <TextHold>
          <TextOne>
            ...
            <p>
              The idea of creating this site came up when i was still trying <br /> to be perfect on how i call my border-line and how  to use <br /> it in making design.
            </p>
          </TextOne>
          <TextTwo>
            <HoldOne>
          ...
          <TextThree>
            <Logo>
              <Link to={"https://global-team.vercel.app/"} style={{
                textDecoration: "none"
              }}>
                <nav>
            ...
            <LogoTwo>
              <Link to={"https://github.com/JbMichael890/Global-Team"} style={{
                textDecoration: "none"
              }}>
                <nav>
