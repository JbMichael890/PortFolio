...
import Image from "../../assets/Screenshot 2024-08-15 185138.png";
    ...
    <Container>
      <Wrapper>
        ...
        <TextHold>
          ...
          <TextThree>
            <Logo>
              <Link to={"https://harmonious-swan-e9b50e.netlify.app/"} style={{
                textDecoration: "none"
              }}>
                <nav>
            ...
            <LogoTwo>
              <Link to={"https://github.com/JbMichael890/JbTechnology"} style={{
                textDecoration: "none"
              }}>
                <nav>
